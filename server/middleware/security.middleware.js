    ...
    helmet({
      contentSecurityPolicy: {
        directives: {
          ...
          imgSrc: ["'self'", 'data:', 'blob:', 'https://res.cloudinary.com', 'http://localhost:*', 'http://127.0.0.1:*'],
          connectSrc: ["'self'", 'http://127.0.0.1:8000', 'http://localhost:5000', 'http://localhost:5173'],
