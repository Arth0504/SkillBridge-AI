...
const runDashboardTests = async () => {
  ...
  try {
    const mongoUri = process.env.TEST_MONGODB_URI || 'mongodb://127.0.0.1:27017/skillbridge_phase5_test';
    ...
    await Application.create({
      ...
      jobId: jobOpen1._id,
      companyId: testCompany._id,
      resumeUrl: 'https://cloudinary.com/resumes/david_miller.pdf',
    ...
    await Application.create({
      ...
      jobId: jobOpen1._id,
      companyId: testCompany._id,
      resumeUrl: 'https://cloudinary.com/resumes/sarah_connor.pdf',
    ...
    await Application.create({
      ...
      jobId: jobOpen1._id,
      companyId: testCompany._id,
      resumeUrl: 'https://cloudinary.com/resumes/john_doe.pdf',
    ...
    await Application.create({
      ...
      jobId: jobOpen2._id,
      companyId: testCompany._id,
      resumeUrl: 'https://cloudinary.com/resumes/bob_jones.pdf',
    ...
    await Application.create({
      ...
      jobId: jobClosed._id,
      companyId: testCompany._id,
      resumeUrl: 'https://cloudinary.com/resumes/charlie_brown.pdf',
      status: APPLICATION_STATUS.SELECTED,
